...
function (_Component) {
  ...
  createClass(DemoSection, [{
    ...
    value: function render() {
      ...
      return React$1.createElement("div", {
      ...
      }, levelName ? React$1.createElement("div", {
        className: "demo-section-header"
      }, levelName) : null, React$1.createElement("div", {
        className: "demo-body",
        style: {
          background: this.getBackground(demos)
        }
      }, React$1.createElement("table", null, React$1.createElement("tbody", null, sizes.length > 0 ? React$1.createElement("tr", {
        className: "demo-head"
      }, React$1.createElement("td", null), sizes.map(function (_ref) {
        ...
        return React$1.createElement("tr", {
          ...
          className: "label"
        }, React$1.createElement("span", null, state)), (sizes.length > 0 ? sizes : ['medium']).map(function (_ref2, index) {
          ...
          return React$1.createElement("td", {
            className: "wrap",
            key: index
          }, React$1.createElement(DemoItem, _extends_1({}, demo, {
            adaptor: adaptor
          })));
        }));
      })))));
...
var generate = (function (Adaptor) {
  ...
  function (_Component) {
      ...
      _this.createContentFilter = function (shape) {
        ...
        return React$1.createElement("ul", {
          ...
          return React$1.createElement("li", {
            key: name
          }, React$1.createElement("span", null, label), op.map(function (item) {
    ...
    createClass(DemoView, [{
        ...
        return shapes.map(function (_ref4) {
          ...
          return React$1.createElement("div", {
            ...
            var label = _ref6.label,
                level = _ref6.value;
            return React$1.createElement(DemoSection, {
              key: level,
              levelName: label,
          ...
          }) : React$1.createElement(DemoSection, {
            key: "all",
            demos: renderDemos,
            adaptor: Adaptor,
            shape: value
      ...
      key: "render",
      value: function render() {
        return React$1.createElement(StyledContainer, null, this.generateDemos());
      }
    }], [{
      key: "getDerivedStateFromProps",
      value: function getDerivedStateFromProps(props) {
    ...
    return DemoView;
  }(Component), _class.componentName = Adaptor.name, _class.Adaptor = Adaptor, _class.propTypes = {
    demos: PropTypes.array,
  ...
  createClass(DemoEditor, [{
    ...
    value: function createEditorItems() {
      ...
      if (Adaptor.shape.length > 1) {
        result.push(React$1.createElement("div", {
          key: "shape",
          className: "form-control"
        }, React$1.createElement("span", {
          className: "form-label"
        }, "Shape "), React$1.createElement("div", {
      ...
      propTypes.forEach(function (_ref2) {
        ...
        switch (type) {
          case Types.string:
            inputNode = React$1.createElement("div", {
              className: "form-input"
            }, React$1.createElement("input", {
              value: value,
              onChange: function onChange(e) {
          ...
          case Types.bool:
            ...
            }, "Yes"), React$1.createElement("input", {
              type: "radio",
              onChange: function onChange(e) {
                return _this2.handlePropsChange(name, !e.target.checked);
              },
    ...
    value: function createPreviewDemo() {
      var demo = this.state.demo;
      var Adaptor = this.props.Adaptor;
      return React$1.createElement(StyledDemo, {
        height: demo.height,
    ...
    value: function render() {
      ...
      var demo = this.state.demo;
      var editor = this.getEditor();
      return React$1.createElement("div", null, React$1.createElement(StyledEditor, null, React$1.createElement("div", {
        className: "editor-header"
      }, "Demo"), React$1.createElement("div", {
        className: "editor-content"
      }, React$1.createElement("div", {
        className: "form-control"
      }, React$1.createElement("span", {
        className: "form-label"
      }, "Height: "), React$1.createElement("div", {
        className: "form-input"
      }, React$1.createElement("input", {
        ...
        className: "form-label"
      }, "Background: "), React$1.createElement("div", {
        className: "form-input"
      }, React$1.createElement("input", {
        ...
        className: "editor-header"
      }, "Options"), React$1.createElement("div", {
        className: "editor-content"
      }, this.createEditorItems()), editor && editor.data && [React$1.createElement("div", {
        key: "header",
        className: "editor-header"
      ...
      }, React$1.createElement(CoolEditor, {
  ...
  createClass(CoolEditor, [{
    ...
    value: function createCoolDemos() {
      ...
      return cools.map(function (_ref, index) {
        ...
        return React$1.createElement(StyledDemo$1, {
          ...
          background: background,
          key: id
        }, Adaptor.adaptor(node.props), React$1.createElement("div", {
    ...
    value: function render() {
      ...
      var Adaptor = this.props.Adaptor;
      return React$1.createElement(StyledCoolEditor, {
        dragEnter: draging,
        onDrop: this.handleOnDrop,
        onDragEnter: this.handleDragEnter,
        onDragOver: this.handleDragOver,
        onDragLeave: this.handleDragLeave
      }, view === 'editor' ? React$1.createElement(DemoEditor, {
        Adaptor: Adaptor,
        demo: demo,
        ref: this.saveEditorRef
      }) : this.createCoolDemos(), view === 'editor' ? React$1.createElement(StyledButton, {
        onClick: this.handleSaveDemo
      }, "Save") : React$1.createElement(StyledButton, {
...
function (_Component) {
  ...
  createClass(ConfigPanel, [{
    ...
    value: function render() {
      ...
      }, "Cool"))), React$1.createElement("div", {
        className: "config-panel-content",
        onDragEnter: this.handleDragEnter
      }, Adaptor && cools && cools.length > 0 && React$1.createElement(CoolEditor$1, {
        Adaptor: Adaptor,
        cools: cools
      })));
    }
  ...
  function (_Component) {
    ...
    createClass(App, [{
      ...
      value: function render() {
        ...
        return React$1.createElement(StyledApp, null, React$1.createElement("div", {
          className: "app-container"
        }, React$1.createElement(DemoView, {
          onDemoInit: this.handleDemoInit
        })), React$1.createElement("div", {
          className: "app-tools"
        }, React$1.createElement(ConfigPanel, {
          cools: cools,
